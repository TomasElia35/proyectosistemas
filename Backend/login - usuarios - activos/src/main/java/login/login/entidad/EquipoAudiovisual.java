...
@Entity
@Table(name = "equipos_audiovisuales")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class EquipoAudiovisual {
    ...
    @Column(name = "idEquipoAV")
    private Integer idEquipoAV;
    ...
    private TipoEquipoAudiovisual tipo;
    ...
    public enum TipoEquipoAudiovisual {
        Proyector,
        Pantalla,
        Parlantes,
        Micrófono("Micrófono"),
        ...
        TipoEquipoAudiovisual() {
            this.displayName = this.name();
        }

        TipoEquipoAudiovisual(String displayName) {
